...
export const description = "Diagnose one Hana agent's current team-observatory status: sessions, background tasks, subagents, usage pressure, and recommendations.";
